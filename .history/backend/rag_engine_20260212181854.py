...
جواب:"""
    ...
    def generate_answer(self, query: str, language: str = "English", original_query: str = None) -> Dict:
        ...
        # --- PHASE 2: HANDLE TB SYMPTOMS QUERY (SPECIAL CASE) ---
        ...
        # --- PHASE 3: HANDLE NON-MEDICAL CHAT ---
    ...
    def _is_symptom_query(self, query: str) -> bool:
        ...
        # English symptom keywords
        symptom_keywords = [
            "symptom", "symptoms", "sign", "signs",
            "what are the", "show me", "tell me about",
            "indication", "indications", "how to know",
