...
def create_comprehensive_qa_dataset():
    """
    Create MASSIVE Q&A dataset (20,000+ questions) from TB knowledge base
    Covers every detail: drugs, treatment, diagnosis, special populations, NTP forms
    """
    
    qa_dataset = {
        "metadata": {
            "title": "TB Medical Expert Q&A Dataset - COMPREHENSIVE EDITION",
            "version": "2.0 - MASSIVE",
            ...
            "coverage": "Every possible question from 275 KB knowledge base"
        },
        "qa_pairs": []
    }
    ...
    print("📖 Reading TB Knowledge Base...")
